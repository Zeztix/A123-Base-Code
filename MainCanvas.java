...
public class MainCanvas extends Canvas {
	...
	public void save(String fileName) {
		try {
			...
			JLabel noteLabel = new JLabel("<html><br><i>Note: Choose extended size if you'd like to see everything when SCROLL was enabled (it's also more reliable).</i></html>");
